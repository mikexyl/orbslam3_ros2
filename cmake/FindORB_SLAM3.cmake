...
set(ORB_SLAM3_ROOT_DIR "/workspaces/src/ORB_SLAM3")
...
set(ORB_SLAM3_LIBRARIES ${ORB_SLAM3_LIBRARY} ${DBoW2_LIBRARY} ${g2o_LIBRARY} ${OpenCV_LIBS})
set(ORB_SLAM3_INCLUDE_DIRS ${ORB_SLAM3_INCLUDE_DIR} ${DBoW2_INCLUDE_DIR} ${Sophus_INCLUDE_DIR} ${OpenCV_INCLUDE_DIRS})